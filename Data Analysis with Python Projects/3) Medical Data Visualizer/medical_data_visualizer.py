...
def draw_cat_plot():
    ...
    f = sns.catplot(x="variable", y="total", hue="value", data=df_cat, kind="bar", col="cardio")
...
def draw_heat_map():
    ...
    ax = sns.heatmap(corr, annot=True, mask=mask, fmt="0.1f", cbar_kws={"shrink": 0.5}, annot_kws={"size": 8})
